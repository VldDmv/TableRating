...
class ManagementPage {
    ...
    applyFilters(searchTerm, filter, view) {
        const term        = (searchTerm !== undefined ? searchTerm : (this.searchInput?.value.trim() ?? '')).toLowerCase();
...
function closeEditModal()   { managementPage?.closeEditModal();   }
function closeDeleteModal() { managementPage?.closeDeleteModal(); }
