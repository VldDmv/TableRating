...
/**
 * Per-IP rate limiter for authentication endpoints. Protects /login, /auth/register, and
 * /api/auth/* from brute-force attacks.
 */
@Component
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private static final Set<String> PROTECTED_PATHS =
            Set.of("/login", "/auth/register", "/api/auth/login", "/api/auth/register");
