...
/**
 * Wraps calls to external media APIs (RAWG, TMDB, OpenLibrary). Caches successful responses in the
 * "externalApi" Caffeine cache so that repeated autocomplete queries don't hit the upstream
 * provider.
 */
@Service
