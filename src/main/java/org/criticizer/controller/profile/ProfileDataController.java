...
/**
 * REST API for fetching profile data (games, movies, books, shows). Supports pagination and
 * filtering.
 */
@RestController
public class ProfileDataController {
    ...
    /** GET /profile-stats Per-category rating statistics for a user's profile. */
    @GetMapping("/profile-stats")
    public ResponseEntity<?> getProfileStats(
            @RequestParam String username, @RequestParam String category) {
    ...
    /**
     * GET /profile-data Fetch paginated media data for a user's profile.
     *
    ...
    public ResponseEntity<?> getProfileData(
        ...
        log.debug(
                "📥 Fetching profile data: username={}, category={}, page={}, pageSize={},"
                        + " search={}, tag_id={}, genre_id={}",
                username,
                category,
                page,
                pageSize,
        ...
        try {
                ...
                return ResponseEntity.badRequest()
                        .body(
                                Map.of(
                                        ...
                                        "validCategories",
                                        List.of("games", "movies", "books", "shows")));
            }
            ...
            log.debug(
                    "Fetched {} items for user {} (category: {}, page: {}/{})",
            ...
            log.error(
                    "Error fetching profile data for user: {}, category: {}",
                    username,
                    category,
                    e);
            return ResponseEntity.internalServerError()
