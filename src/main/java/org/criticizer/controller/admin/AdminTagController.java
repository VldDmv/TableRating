...
/**
 * MVC Controller for admin tag management.
 *   POST /admin/tags with ?action=add|update|delete
 */
@Controller
    ...
    public String handleTagAction(
        ...
        try {
            switch (action) {
                ...
                default -> redirectAttributes.addFlashAttribute("flashErrorMessage",
            ...
            redirectAttributes.addFlashAttribute("flashErrorMessage",
                    "Cannot delete tag: it is currently assigned to games");
        } catch (Exception e) {
