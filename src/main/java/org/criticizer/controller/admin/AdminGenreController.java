...
/**
 * MVC Controller for admin genre management operations.
 * Handles form-based genre operations (create, update, delete).
...
public class AdminGenreController {
    ...
    public String handleGenreAction(
        ...
        try {
            List<String> mediaTypeList = mediaTypes != null
            ...
            redirectAttributes.addFlashAttribute("flashErrorMessage",
                    "Cannot delete genre: it is currently in use");
        } catch (Exception e) {
