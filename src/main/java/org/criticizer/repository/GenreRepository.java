...
/** Repository for Genre entity. Contains ONLY data access methods - NO business logic. */
@Repository
public interface GenreRepository extends JpaRepository<Genre, Integer> {
    ...
    /**
     * Find genres available for specific media type. Includes 'shared' genres and media-specific
     * genres.
     */
    @Query(
    ...
    /** Check if genre is used by any movies. Returns count for efficiency. */
