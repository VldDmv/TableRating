...
import org.criticizer.servlets.admin.AdminDeleteUserServlet;
...
class AdminDeleteUserServletTest {
    ...
    private AdminDeleteUserServlet servlet;
    ...
    void setUp() throws ServletException {
        ...
        servlet = new AdminDeleteUserServlet();
    ...
    @Test
    void doPost_ValidDelete_ShouldDeleteUserAndRedirect() throws ServletException, IOException {
        when(request.getParameter(RequestParams.USER_ID)).thenReturn("2");

        servlet.doPost(request, response);

        verify(userService).deleteUser(2, initiator);
    ...
    void doPost_ServiceException_ShouldSetErrorAndRedirect() throws ServletException, IOException {
        ...
        doThrow(new DatabaseException("Database error", new RuntimeException()))
                .when(userService).deleteUser(2, initiator);
