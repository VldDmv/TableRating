...
class BookServiceTest {
    ...
    class GetUserItemsPageTests {
        ...
        void shouldReturnPaginatedBooks() {
            ...
            when(bookRepository.findItemIds(eq(TEST_USER_ID), isNull(), isNull(), any(), any(), any(), any()))
                    .thenReturn(bookIds);
        ...
        void shouldFilterByGenre() {
            ...
            verify(bookRepository).findItemIds(eq(TEST_USER_ID), eq(1), isNull(), any(), any(), any(), any());
        }
    }
